...
You have completed Week 3's exercises. Move on to the [challenge](../04-challenges/challenge-01-one-command-spinup-with-seed-data.md) and then the [mini-project](../07-mini-project/00-overview.md).
