...
| [resources.md](./01-resources.md) | Curated readings: kernel docs, OCI specs, free books |
| [lecture-notes/01-namespaces-cgroups-and-the-container-mental-model.md](./02-lecture-notes/01-namespaces-cgroups-and-the-container-mental-model.md) | The kernel features that make containers possible |
| [lecture-notes/02-from-tarball-to-image-the-oci-stack.md](./02-lecture-notes/02-from-tarball-to-image-the-oci-stack.md) | OCI image format, runtimes, engines, registries |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of short hands-on drills |
| [exercises/exercise-01-build-a-container-by-hand.md](./03-exercises/exercise-01-build-a-container-by-hand.md) | Build a container with `unshare` + `chroot` + a tarball |
| [exercises/exercise-02-first-real-docker.md](./03-exercises/exercise-02-first-real-docker.md) | Build the same container with Docker; compare |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of weekly challenges |
| [challenges/challenge-01-shrink-the-image.md](./04-challenges/challenge-01-shrink-the-image.md) | Take a 1GB image to under 50MB without breaking it |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions |
| [homework.md](./06-homework.md) | Six practice problems |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Full spec for the "Containerize an Existing App" project |
