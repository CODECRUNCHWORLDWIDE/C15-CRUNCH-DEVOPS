...
There is a sample app in the [Exercise 1 starter](./03-exercises/exercise-01-three-builds-three-images.md); reuse it (or write your own one-file Flask app + `requirements.txt`).
...
When done, push your week-02 repo and start the [mini-project](./07-mini-project/00-overview.md).
