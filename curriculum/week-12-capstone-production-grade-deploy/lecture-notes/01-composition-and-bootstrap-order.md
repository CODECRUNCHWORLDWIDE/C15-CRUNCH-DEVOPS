...
```mermaid
flowchart TD
  P0["Phase 0 - control plane"] --> P1["Phase 1 - ArgoCD installed"]
  P1 --> P2["Phase 2 - CRDs sync wave 0"]
  P2 --> P3["Phase 3 - ingress-nginx cert-manager external-dns"]
  P3 --> P4["Phase 4 - observability stack"]
  P4 --> P5["Phase 5 - Vault and Kyverno"]
  P5 --> P6["Phase 6 - OpenCost"]
  P6 --> P7["Phase 7 - application"]
  P7 --> P8["Phase 8 - smoke test"]
```
*The bootstrap order, phase by phase, each one waiting on the last.*
