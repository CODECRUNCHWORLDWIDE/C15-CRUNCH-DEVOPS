...
When done, push the repo and continue to the [Saturday challenge](../04-challenges/challenge-01-build-and-push-to-ghcr.md) and the [mini-project](../07-mini-project/00-overview.md).
