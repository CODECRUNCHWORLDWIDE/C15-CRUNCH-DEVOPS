...
- [week 01 what is a container](./curriculum/week-01-what-is-a-container/00-overview.md)
- [week 02 dockerfiles that dont suck](./curriculum/week-02-dockerfiles-that-dont-suck/00-overview.md)
- [week 03 docker compose 12 factor](./curriculum/week-03-docker-compose-12-factor/00-overview.md)
- [week 04 github actions](./curriculum/week-04-github-actions/00-overview.md)
- [week 05 terraform fundamentals](./curriculum/week-05-terraform-fundamentals/00-overview.md)
- [week 06 gitops and immutable infra](./curriculum/week-06-gitops-and-immutable-infra/00-overview.md)
- [week 07 kubernetes from first principles](./curriculum/week-07-kubernetes-from-first-principles/00-overview.md)
- [week 08 managed kubernetes and addons](./curriculum/week-08-managed-kubernetes-and-addons/00-overview.md)
- [week 09 observability prometheus grafana loki otel](./curriculum/week-09-observability-prometheus-grafana-loki-otel/00-overview.md)
- [week 10 secrets and supply chain](./curriculum/week-10-secrets-and-supply-chain/00-overview.md)
- [week 11 cost and finops](./curriculum/week-11-cost-and-finops/00-overview.md)
- [week 12 capstone production grade deploy](./curriculum/week-12-capstone-production-grade-deploy/00-overview.md)
